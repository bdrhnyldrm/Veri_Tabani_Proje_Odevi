...
namespace Deneme
{
    public partial class uyeArama : Form
    {
        ...
        private void button4_Click(object sender, EventArgs e)
        {
            ...
            {
                string sorgu = "select * from tbl_uyeler where kisi_id=@ID";
            ...
            {
                string sorgu = "select * from tbl_uyeler where ad=@ad";
                NpgsqlCommand komut = new NpgsqlCommand(sorgu, baglanti);
            ...
            {
                string sorgu = "select * from tbl_uyeler where soyad=@soyad";
                NpgsqlCommand komut = new NpgsqlCommand(sorgu, baglanti);
            ...
            {
                string sorgu = "select * from tbl_uyeler where adres_id=@ID";
                NpgsqlCommand komut = new NpgsqlCommand(sorgu, baglanti);
